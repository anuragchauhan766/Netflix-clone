          ...
          <div className="max-w-[320px] mx-auto py-16">
            ...
            <form onSubmit={(e) => handleSubmit(e)}>
              ...
              <button
                ...
                className="disabled:bg-gray-500 w-full my-4 p-4 bg-red-600 rounded-md text-lg font-bold">
                Sign Up
              </button>
            </form>
            ...
            <div className="flex items-center mt-16 text-md">
              <p className="mr-2 text-gray-500">Already Subscribed to Netflix?</p>
